...
export const WhatsAppFab = () => (
  <a
    ...
    className="fixed bottom-5 right-5 z-40 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-white shadow-elegant transition-transform hover:scale-[1.03] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-background max-[380px]:right-3 max-[380px]:bottom-3 md:right-[68px]"
    style={{
      // Avoid collision with iOS home indicator / Android gesture bar
