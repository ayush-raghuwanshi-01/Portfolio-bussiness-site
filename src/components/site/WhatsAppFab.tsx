...
export const WhatsAppFab = () => (
  <a
    ...
    aria-label="Chat with ZenVioLabs on WhatsApp"
    className="fixed bottom-5 right-5 z-40 inline-flex items-center gap-2 rounded-full px-4 py-3 text-sm font-semibold shadow-elegant transition-transform hover:scale-[1.03] focus-visible:outline-none md:right-[68px]
      bg-[#25D366] text-white hover:bg-[#20bd5a] active:bg-[#1da150]"
  >
