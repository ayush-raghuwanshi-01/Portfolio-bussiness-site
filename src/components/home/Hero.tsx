  ...
  <section className="surface-paper relative isolate overflow-hidden pb-20 pt-32 sm:pt-36">
    ...
    <div className="container relative">
      <div className="mb-8 flex flex-wrap items-center gap-2">
        <span className="inline-flex items-center gap-2 rounded-full border border-success/35 bg-success/10 px-3 py-1 text-xs font-semibold text-success backdrop-blur-sm">
      ...
      <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <div key={stat.v} className="glass-strong hover-lift rounded-[24px] bg-card/65 p-5 backdrop-blur-md">
            ...
            <div className="mt-1 text-xs text-foreground/70">{stat.note}</div>
          </div>
        ))}
      </div>
    </div>
